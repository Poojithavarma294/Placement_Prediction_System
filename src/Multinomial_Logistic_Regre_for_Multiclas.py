...
if not os.path.exists(DATASET_FILE):
    ...
    print("\nPlace the CSV file in the correct folder.")
    exit()
...
if number_of_classes < 3:
    ...
    print("This program is intended for a multi-class problem.")
...
if len(non_numeric_columns) > 0:
    print("\nERROR:")
    print("The dataset is expected to be already preprocessed.")
...
if missing_values > 0:
    print("\nERROR:")
    print("Missing values were found in the preprocessed features.")
    print("\nMissing values by column:")
    print(X.isnull().sum())
    print("\nThe original dataset will NOT be modified.")
    print("Please use a properly preprocessed dataset.")
    exit()
...
# multi_class parameter removed because newer
# scikit-learn versions do not accept it.
